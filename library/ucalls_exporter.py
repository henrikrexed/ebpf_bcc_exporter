...
histogram_latency = Histogram('ebpf_ucalls_latency', 'method calls',['method'])
...
while True:
    ...
    for key, value in data:
        ...
        histogram_latency.labels('method','%-50s' %key).observe(time)
        histogram_calls.labels('method','%8d'  %key).observe(value[0])
